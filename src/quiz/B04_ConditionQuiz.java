...
//   	
		...
		//문자열은(참조형 변수들은) ==으로 비교하면 안된다.
		//참조형 타입의 값을 비교할 때는 클래스에 정의되어 있는 equals()라는 메서드를 이용해야한다
		System.out.println(str == "yes");
		System.out.println(str.equals("yes"));
		
		// 기본형 타입과 참조형 타입의 차이
		// 기본형 타입은 내부 데이터의 크기를 예측하기 쉽다 (차곡차곡 쌓인다) 스택 
		// 참조형 타입은 내부 데이터의 크기를 예측하기 어렵다 (랜덤으로 쓰인다)힙
		String str1 = "yes";
